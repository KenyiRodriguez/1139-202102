...
registrarUsuarioConNombre("Ricardo", apellido: "Saravia")
registrarUsuarioConNombre("Jorge", apellido: "Rojas", pais: "Mexico")
registrarUsuarioConNombre("Rebeca", apellido: "Ruiz", sexo: "Femenino")
registrarUsuarioConNombre("Kenyi", apellido: "Rodriguez", sexo: "Maculino", pais: "España")
